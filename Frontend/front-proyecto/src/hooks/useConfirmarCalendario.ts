...
interface Confirmarcalendario {
    ...
    pruebas: {id_asignatura: number; id_columna: number; horario: string; id_profesores: number[] | undefined; profesores: string[] | undefined; salas: string[] | undefined; id_salas: number[] | undefined; profesor_error: boolean[] | undefined; eliminado: boolean; celdaid: string}[];
